...
if ($blog1){
    echo "blog数据库创建成功！".'<br/>';
    $sql2="CREATE TABLE blog.arts(id INT(4) NOT NULL AUTO_INCREMENT,title VARCHAR(50) NOT NULL,time DATE NOT NULL , content TEXT NOT NULL ,  hits INT(11) NOT NULL, like INT(4) ,PRIMARY KEY (id))";
    ...
    if($blog5)
        echo '注册资料创建成功！'.'<br/>';
    $sql6="CREATE TABLE blog.say(id INT(4) NOT NULL AUTO_INCREMENT, content TEXT NOT NULL,time DATE NOT NULL,like INT(4),PRIMARY KEY(id))";
